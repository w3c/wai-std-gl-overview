...
lang: zh-cmn-Hans   # Change "en" to the translated language shortcode from https://www.iana.org/assignments/language-subtag-registry/language-subtag-registry

last_updated: 2019-07-12   # Put the date of this translation YYYY-MM-DD (with month in the middle)
# translators: 
# - name: "anjia"   # Replace @@ with translator name
...
footer: >   # Translate all the words below, including "Date:" and "Editor:". Do not change these dates.
  <p><strong>日期:</strong> 更新于2019年7月12日.</p>
  <p><strong>编辑:</strong> <a href="https://github.com/anjia">安佳</a>.</p>
  <p>根据教育和外联工作组的意见制定（<a href="https://www.w3.org/WAI/EO/">EOWG（Education and Outreach Working Group）</a>）.</p>
